...
var IPMapper = {
	...
	initializeMap: function(mapId){
        var SW = new google.maps.LatLng(0, -140);
        var NE = new google.maps.LatLng(50, -70);
		IPMapper.latlngbound = new google.maps.LatLngBounds(SW, NE);
		var latlng = new google.maps.LatLng(35, -98);
		//set Map options
		var mapOptions = {
			zoom: 1,
            center: {lat: 35.6894, lng: -98},
